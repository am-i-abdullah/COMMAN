...
class EmployeeHRM extends ConsumerStatefulWidget {
  const EmployeeHRM({super.key, required this.orgId});
  final String orgId;
  @override
  ConsumerState<EmployeeHRM> createState() => _EmployeeHRMState();
}

class _EmployeeHRMState extends ConsumerState<EmployeeHRM> {
  void refresh() {}
  @override
  Widget build(BuildContext context) {
    String? rank = ref.read(rankProvider.notifier).state;
    // teams in hrm
